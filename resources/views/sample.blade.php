				...
				<div class="vertical-middle slider-element-fade">
					<div class="container text-start py-5">
						<div class="emphasis-title bottommargin-sm">
							...
							<p class="lead topmargin-sm mb-0" style="max-width:700px; line-height: 1.7;">One Stop Solution Center for all Your Design &amp; Branding<br> Needs. Start with a <strong>Canvas</strong> &amp; explore Unlimited Possibilities.</p>
						</div>
						<a href="#" class="button button-dark button-circle button-large fw-light ms-0" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="70"><i class="icon-apple"></i>App Store</a>
						<a href="#" class="button button-dark button-circle button-large fw-light" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="70"><i class="icon-googleplay"></i>Google Play</a>
					</div>
				</div>
			...
			<div class="content-wrap py-0">
				...
				<div id="section-about" class="center page-section">
					...
					<div class="container clearfix">
						...
						<h2 class="mx-auto bottommargin font-body" style="max-width: 700px; font-size: 40px;">A digital web studio creating stunning &amp; engaging online experiences</h2>
				...
				<div id="section-works" class="page-section pt-0">
					...
					<div class="section m-0">
						<div class="container clearfix">
							<div class="mx-auto center" style="max-width: 900px;">
								<h2 class="mb-0 fw-light ls1">We create &amp; craft projects that ooze creativity in every aspect. We try to create a benchmark in everything we do. Take a moment to browse through some of our recent completed work.</h2>
							</div>
						</div>
					</div>
					...
					<div class="topmargin center"><a href="#" class="button button-border button-circle fw-semibold">View More Projects</a></div>
