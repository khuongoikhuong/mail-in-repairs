...
<section id="slider" class="slider-element slider-parallax min-vh-100 include-header">
   <div class="slider-inner" style="background-image: url('one-page/images/page/ps5-slider2.png'); background-color: #FFF;">
      <div class="vertical-middle slider-element-fade">
         <div class="container text-start py-5">
            <div class="emphasis-title bottommargin-sm">
               <h1 class="text-uppercase fw-semibold" style="font-size: 56px; letter-spacing: 8px;"><font style="color: red;">PS5</font><br>Mail-In Repair Service</h1>
